...
Model
Chắc chắn rồi. File README của bạn đã rất tốt, chỉ cần tinh chỉnh lại một chút về định dạng Markdown để nó hiển thị đẹp và chuyên nghiệp nhất trên GitHub.
Dưới đây là phiên bản đã được định dạng lại hoàn chỉnh. Tôi đã sửa các tiêu đề, danh sách, và khối code để chúng tuân thủ đúng cú pháp Markdown.
README.md (Phiên bản Hoàn thiện với Cú pháp GitHub)
code
Markdown
# ASTF-AD: Adaptive Semantic-Texture Fusion for Few-Shot Industrial Anomaly Detection
